...
dataset = 'ocelot'
target_molecule = 0
report_save_path_base = '/work/mech-ai/bella/ChemTransformer/report/GenerativeMethods/test_optimistic_property_driven_molecules_generation/'
...
molecules_generation_record = GM.optimistic_property_driven_molecules_generation(initial_smile = interest_molecules[dataset][target_molecule],dataset = dataset,k = 100,num_vector = 100, sa_threshold = 6,resolution = 0.0001,search_range = 60,max_step = 10,alpha = 0.5) # dataset can be your own csv file, make sure the files contains 'SELFIES' 
